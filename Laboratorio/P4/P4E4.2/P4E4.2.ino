...
BLECharacteristic accelerometerDataCharacteristic("19B10001-E8F2-537E-4F6C-D104768A1214", BLERead | BLENotify, 20); // Aumenta el tamaño para acomodar los datos del acelerómetro
  ...
  if (central) {
    ...
    while (central.connected()) {
      ...
      if (accelerometerEnabled) {
        ...
        // Enviar los valores del acelerómetro como texto
        String data = String(x) + "," + String(y) + "," + String(z);
        accelerometerDataCharacteristic.writeValue(data.c_str());
